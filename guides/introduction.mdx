...
ProductBrain is built by Anthony Lee, with experience across product management, software engineering, and design. The product is self-funded, actively shipping, and built on the conviction that the model matters more than the ceremony.
